...
class AbstractConfiguration(ABC):
    ...
    - **Drivers**: each unique system using this hardware manager implementation can have different drivers.
        A driver is just a python class that provides an interface for interactive with any kind of hardware.
    ...
    If handlers require more complexity, create custom functions to use as handlers.
